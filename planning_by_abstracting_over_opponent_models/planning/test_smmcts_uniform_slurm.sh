...
#SBATCH --error=slurm-smmcts_uniform_%A_%a.err
#SBATCH --output=slurm-smmcts_uniform_%A_%a.out
...
python -u test_smmcts.py --policy-estimation uniform --opponent-classes "simple, simple, simple" --nb-games 2 --nb-plays 10 --mcts-iterations 1000 --fpu 1000