...
python -u test_smmcts.py --model-iterations 1380 --policy-estimation neural_network --opponent-classes "static, static, static" --nb-games 10 --nb-plays 10 --mcts-iterations 5000 --fpu 1000