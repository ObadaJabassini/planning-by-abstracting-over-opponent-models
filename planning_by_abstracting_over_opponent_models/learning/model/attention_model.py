...
class AttentionModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.output_size = latent_dim * 2 if self.attention_operation == "concat" else latent_dim
    ...
    def forward(self, agent_latent, opponent_latents):
        ...
        agent_latent = self.compute_agent_latent(agent_latent, attn_output)
    ...
    def compute_agent_latent(self, agent_latent, attn_output):
        if self.attention_operation == "concat":
            return torch.cat((agent_latent, attn_output), dim=-1)
        elif self.attention_operation == "add":
